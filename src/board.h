...
private:
    ...
    int m_width;
    int m_height;
    // m_storage guarda los objetos reales de cada caramelo
    Candy* m_storage[DEFAULT_BOARD_WIDTH][DEFAULT_BOARD_HEIGHT];
    // m_board guarda punteros a esas posiciones o nullptr si la celda esta vacia
    Candy* m_board[DEFAULT_BOARD_WIDTH][DEFAULT_BOARD_HEIGHT];

    // metodo auxiliar para shouldExplode
